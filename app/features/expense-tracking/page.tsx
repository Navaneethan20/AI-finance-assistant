                  ...
                  <div className="relative z-10 flex flex-col gap-6">
                    <div className="flex items-center justify-between">
                      <div className="flex items-center gap-2">
                        ...
                        <span className="font-semibold text-primary dark:text-primary-foreground">Expense Summary</span>
                      </div>
                    </div>
                    ...
                    <div className="space-y-3">
                      <div className="flex justify-between items-center">
                        ...
                        <span className="text-sm font-medium dark:text-white">₹12,500</span>
                      </div>
                      ...
                      <div className="flex justify-between items-center">
                        ...
                        <span className="text-sm font-medium dark:text-white">₹5,200</span>
                      </div>
                      <div className="h-2 w-full rounded-full bg-primary/10 dark:bg-primary/5">
                      ...
                      <div className="flex justify-between items-center">
                        <span className="text-sm text-muted-foreground dark:text-gray-300">Entertainment</span>
                        <span className="text-sm font-medium dark:text-white">₹3,800</span>
                      </div>
                      <div className="h-2 w-full rounded-full bg-primary/10 dark:bg-primary/5">
                    ...
                    <div className="grid grid-cols-2 gap-4">
                      <div className="h-20 rounded-md bg-primary/20 dark:bg-primary/10 p-3 flex flex-col justify-between">
                        <div className="text-xs text-primary/70 dark:text-primary-foreground/70">Total Expenses</div>
                        <div className="text-lg font-semibold text-primary dark:text-primary-foreground">₹21,500</div>
                      </div>
                      <div className="h-20 rounded-md bg-primary/20 dark:bg-primary/10 p-3 flex flex-col justify-between">
                        <div className="text-xs text-primary/70 dark:text-primary-foreground/70">Monthly Trend</div>
